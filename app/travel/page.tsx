    ...
    <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-950">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg text-slate-600 dark:text-slate-400 mb-12 max-w-2xl mx-auto">
          Photography and stories from my travels around the world.
        </p>
        <div className="bg-slate-50 dark:bg-slate-900 p-12 rounded-2xl border border-slate-200 dark:border-slate-800">
          <p className="text-slate-600 dark:text-slate-400 mb-6">
            🌍 Coming soon! I love exploring new places and capturing moments.
          </p>
          <p className="text-sm text-slate-500 dark:text-slate-400">
            This section will feature travel photography, tips, and experiences
