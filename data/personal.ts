export const personalInfo = {
  name: "Arefin Aziz Sifat",
  title: "M.Eng AI Engineering Student",
  tagline: "Engineering AI systems with production-ready discipline",
  ...
  education: [
    {
      degree: "M.Eng in AI Engineering of Autonomous Systems",
  ...
  languages: [
    ...
    {
      language: "German",
      proficiency: "Intermediate (learning)"
    }
  ],
  certificates: [
    {
